...
def main_menu():
    ...
    while menu:
        ...
        # Main Menu Text
        screen.blit(title, (screen_width / 2 - (title_rect[2] / 2), 200)) #50
        screen.blit(text_start, (screen_width / 2 - (start_rect[2] / 2), 400)) #300
        screen.blit(text_change, (screen_width / 2 - (change_rect[2] / 2), 550)) #450
        screen.blit(text_quit, (screen_width / 2 - (quit_rect[2] / 2), 700)) #600
