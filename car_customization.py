...
def customize_car():
    ...
    while customization:
        ...
        screen.fill((0, 0, 0))
        img = pygame.image.load("Images/car_colors.jpg").convert()
        ...
        screen.blit(text_black, (screen_width / 2 - (black_rect[2] / 2), 150))
        screen.blit(text_blue, (screen_width / 2 - (blue_rect[2] / 2), 280))
        screen.blit(text_green, (screen_width / 2 - (green_rect[2] / 2), 410))
        screen.blit(text_orange, (screen_width / 2 - (orange_rect[2] / 2), 540))
        screen.blit(text_yellow, (screen_width / 2 - (yellow_rect[2] / 2), 670))
